...
import com.appsmata.qtoa.adapters.PostsSliderAdapter;
import com.appsmata.qtoa.models.Callback.CallbackPostsLists;
import com.appsmata.qtoa.models.Callback.CallbackPostsSlider;
...
import com.appsmata.qtoa.setting.ToolsUtils;
...
public class PostsSliderFragment extends Fragment {
    ...
    private void component() {
        root_recycler = root_view.findViewById(R.id.lyt_cart);
    ...
    private void displayFromServer(List<PostsSlider> postsSliders){
        ...
        postsSliderAdapter.setOnItemClickListener(new PostsSliderAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, PostsSlider posts) {
                //QtoAndy.navigateParent(getActivity(), posts.postid, false);
