...
import com.appsmata.qtoa.models.Callback.FeedbackModal;
...
public class Feedback extends AppCompatActivity{
    ...
    private void showSuccessPopup() {
        ...
        builder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Intent intent = new Intent(getApplicationContext(), CategoryAll.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Feedback.this, CategoryAll.class);
        startActivity(intent);
        overridePendingTransition(R.anim.animation_right_left, R.anim.animation_blank);
    }
}
