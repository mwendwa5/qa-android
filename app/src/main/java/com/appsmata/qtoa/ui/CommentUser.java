...
public class CommentUser extends AppCompatActivity{
    ...
    private void initInterface() {
        posts_id = getIntent().getIntExtra(EXT_OBJ_ID, 0);
        ...
        //Picasso.with(getApplicationContext()).load(prefget.getString("app_base_url", BaseUrlConfig.BaseUrl)+BaseUrlConfig.BaseUrl_IMAGE+get_user_photo).memoryPolicy(MemoryPolicy.NO_CACHE).networkPolicy(NetworkPolicy.NO_CACHE).into(user_comment);
        ...
        user_comment_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (get_comment.isEmpty()){
                    ...
                    sendComment(String.valueOf(id), String.valueOf(posts_id), get_comment);
                    Log.d("UserId", String.valueOf(id));
                    Log.d("PostsId", String.valueOf(posts_id));
                    Log.d("CommentUser", get_comment);
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            CommentShow.navigateParentFromCommentUser(CommentUser.this, posts_id);
                        }
                    }, 1500);
                }
            }
    ...
    private void sendComment(final String app_user, final String posts_id, final String comment) {
        showDialog();
                ...
                StringRequest request = new StringRequest(Request.Method.POST, prefget.getString("app_base_url", BaseUrlConfig.BaseUrl),
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("com.appsmata.qtoa_comment")){
