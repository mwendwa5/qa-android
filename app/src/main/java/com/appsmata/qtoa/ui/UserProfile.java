...
public class UserProfile extends AppCompatActivity {
    ...
    private void initInterface() {
        ...
        id_userse = prefget.getInt("Login_user_id", 0);
        id_users = prefget.getString("Login_profile_image", "");
        name = prefget.getString("Login_name", "");
        email = prefget.getString("Login_email", "");
        user_Registration = prefget.getString("Login_created_at", "");
        ...
        edit_process.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!update_name.isEmpty()){
                    ...
                    prefedit.putString("Login_name", user_name.getText().toString());
                    prefedit.apply();
                }else{
        ...
        StringRequest request = new StringRequest(Request.Method.POST, prefget.getString("app_base_url", BaseUrlConfig.BaseUrl) + BaseUrlConfig.UPDATE, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success.equals("com.appsmata.qtoa")){
